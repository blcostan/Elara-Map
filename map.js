...
// 1. Spire District Boundary Coordinates (Adjusted to hug Downtown's eastern/southern border)
const spireCoords = [
    ...
    // Hug Downtown's border segments where they meet:
...
const downtownCoords = [
    ...
    // Head East on Wade Ave toward Oberlin:
