 <script>
        ...
        // 3. Sumptown Boundary Coordinates (with curved southeastern transition filled in)
        const sumptownCoords = [
            // Start at bottom of Spire's eastern border
            [35.75780993474421, -78.61280301624038],
            // Go UP north hugging Spire's eastern border to MLK Jr Blvd
            [35.76981382377968, -78.61443431358302],
            // Turn right/east along MLK Blvd
            ...
            // Head South on 440 with smooth intermediate curve points
            [35.7679089212448, -78.57417198368348],
            [35.761888550283054, -78.5747030339163],
            [35.75830925788647, -78.57659671392976],
            [35.756785573836844, -78.5778412904846],
            [35.754748226341334, -78.58089900873085],
            [35.75386013546752, -78.58333445474182],
            [35.75339873349045, -78.58878467035257],
            // Head West on 440 to I-40
            [35.75334711169578, -78.59122349178183],
            [35.754506782725905, -78.59818980028047],
            [35.757547368962925, -78.60660214172542],
            [35.75752937590674, -78.60658119192838],
            [35.75780798086611, -78.61280391615834]
        ];
        ...
        // --- INTERACTIVE STORYTELLING POI 1 (Cloud Plaza) ---
        ...
        `;
        cloudPlazaMarker.bindPopup(plazaContent);

        // --- INTERACTIVE STORYTELLING POI 2 (The Aetherium) ---
        ...
        `;
        aetheriumMarker.bindPopup(aetheriumContent);

        // --- INTERACTIVE STORYTELLING POI 3 (Ashby Library) ---
        ...
        `;
        ashbyLibraryMarker.bindPopup(ashbyLibraryContent);

        // --- INTERACTIVE STORYTELLING POI 4 (University Arboretum) ---
        ...
        `;
        arboretumMarker.bindPopup(arboretumContent);

        // --- INTERACTIVE STORYTELLING POI 5 (The Belltower) ---
        ...
        `;
        belltowerMarker.bindPopup(belltowerContent);

        // --- INTERACTIVE STORYTELLING POI 6 (Jax's Lab) ---
        ...
        `;
        jaxLabMarker.bindPopup(jaxLabContent);

	// --- INTERACTIVE STORYTELLING POI 7 (Cypress-Mire Market) ---
        ...
        `;
        cypressMireMarker.bindPopup(cypressMireContent);
	
	// --- INTERACTIVE STORYTELLING POI 8 (The Sump-Lock) ---
...
`;
sumpLockMarker.bindPopup(sumpLockContent);

// --- INTERACTIVE STORYTELLING POI 9 (KiKi's Childhood Home) ---
